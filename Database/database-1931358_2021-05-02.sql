...
-- Dumping data for table database-1931358.customers: ~4 rows (approximately)
...
-- Dumping data for table database-1931358.purchases: ~4 rows (approximately)
...
INSERT INTO `purchases` (`purchase_id`, `fk_customer_id`, `fk_product_id`, `purchase_quantity`, `product_price`, `purchase_comment`, `purchase_creationTime`, `purchase_modificationTime`, `purchase_subtotal`, `purchase_taxesAmount`, `purchase_grandTotal`) VALUES
	...
	('5a650cd6-aaf1-11eb-b52c-3c7c3f5e1be6', '15f40d35-a1d2-11eb-a0b5-3c7c3f5e1be6', '44eb4dd1-a1d2-11eb-a0b5-3c7c3f5e1be6', 4, 10.45, 'Comment', '2021-05-01 22:51:54', '2021-05-01 22:51:54', 41.80, 6.35, 48.15),
