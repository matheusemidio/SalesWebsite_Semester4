...
-- Dumping data for table database-1931358.customers: ~5 rows (approximately)
...
INSERT INTO `customers` (`customer_id`, `customer_firstName`, `customer_lastName`, `customer_address`, `customer_city`, `customer_province`, `customer_postalCode`, `customer_username`, `customer_password`, `customer_creationTime`, `customer_modificationTime`) VALUES
	('15f40d35-a1d2-11eb-a0b5-3c7c3f5e1be6', 'Matheus', 'Cadena', '5178', 'Montreal', 'Quebec', '543 h12', 'matheus', '$2y$10$Hs9ZBwkizaCOsQZ8cgpXFOLnVuBFIjw0L6VaQRKLjW1MXmxQlWw2i', '2021-04-20 08:15:24', '2021-04-30 23:40:26'),
	...
	('f43cf74b-a9b9-11eb-b38a-3c7c3f5e1be6', 'ANTONIO', 'Cadena', 'Rua Ovídio', 'João Pessoa', 'PB', '58043', 'antonio', '$2y$10$pw12lcJvNGlE2y9SVE5Gfui3h.AkExxQBHHqzLuNIaPhB0motbgou', '2021-04-30 09:42:49', '2021-04-30 09:42:49');
...
CREATE TABLE IF NOT EXISTS `purchases` (
  ...
  `purchase_subtotal` decimal(7,2) DEFAULT NULL,
  `purchase_taxesAmount` decimal(7,2) DEFAULT NULL,
  `purchase_grandTotal` decimal(7,2) DEFAULT NULL,
...
INSERT INTO `purchases` (`purchase_id`, `fk_customer_id`, `fk_product_id`, `purchase_quantity`, `product_price`, `purchase_comment`, `purchase_creationTime`, `purchase_modificationTime`, `purchase_subtotal`, `purchase_taxesAmount`, `purchase_grandTotal`) VALUES
	('7ee90a05-a1d2-11eb-a0b5-3c7c3f5e1be6', '15f40d35-a1d2-11eb-a0b5-3c7c3f5e1be6', '44eb4dd1-a1d2-11eb-a0b5-3c7c3f5e1be6', 5, 10.45, NULL, '2021-04-20 08:18:20', '2021-04-20 08:18:20', NULL, NULL, NULL),
	('e5271d23-aa3b-11eb-b38a-3c7c3f5e1be6', '15f40d35-a1d2-11eb-a0b5-3c7c3f5e1be6', 'd737bd73-aa24-11eb-b38a-3c7c3f5e1be6', 2, 49.00, 'Comment', '2021-05-01 01:12:58', '2021-05-01 01:12:58', 98.00, 14.90, 112.90);
...
CREATE TABLE `purchases_view_all` (
	...
	`purchase_subtotal` DECIMAL(7,2) NULL,
	`purchase_taxesAmount` DECIMAL(7,2) NULL,
	`purchase_grandTotal` DECIMAL(7,2) NULL,
